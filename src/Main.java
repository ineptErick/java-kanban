...
public class Main {
    public static void main(String[] args) {
        ...
        Task task = new Task(1,"Задача","Описание задачи",NEW);
        manager.addTask(task);
        manager.getHistory();

        System.out.println("Создаю эпик с 2-я подзадачами...");
        Epic epic = new Epic(1,"Эпик", "Описание эпика",NEW);
        ...
        Subtask subtaskSecond = new Subtask(1,"Вторая подзадача", "Описание второй подзадачи", NEW, epic.getId());
        ...
        Task taskUpdated = new Task(2,"Обновленная задача","Описание обновленной задачи",NEW);
        manager.updateTask(taskUpdated);

        System.out.println("Обновляю первую подзадачу...");
        Subtask subtaskFirstUpdated = new Subtask(3,"Обновленная первая подзадача","Обновленное описание первой задачи",NEW, epic.getId());
